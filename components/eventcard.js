...
const EventCard = ({ event, onPress }) => {
  ...
  const eventStatus = React.useMemo(() => getEventStatus(), [event.startDate, event.endDate, theme.colors.primary.main, theme.colors.primary.lightest, theme.colors.success.main, theme.colors.success.lightest, theme.colors.text.secondary, theme.colors.gray[200]]);
