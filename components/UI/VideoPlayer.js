 ...
 * @param {boolean} [props.autoPlay=false] - Whether to auto-play the video
 * @param {boolean} props.loop - Whether to loop the video (default: false)
 * @param {boolean} [props.muted=false] - Whether the video is muted
 * @param {boolean} [props.showControls=true] - Whether to show video controls (default: true)
 * @param {boolean} [props.resizeMode='contain'] - Video resize mode
 ...
 * @param {boolean} [props.showFullscreenButton=true] - Whether to show fullscreen button (default: true)
...
const VideoPlayer = ({
  ...
  return (
    <View style={[styles.container, style]}>
      {/* Video */}
      <Pressable style={styles.videoContainer} onPress={toggleControls} accessibilityRole="button">
        <Video
          ref={videoRef}
          source={getSource()}
          style={styles.video}
