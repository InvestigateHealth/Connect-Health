...
const palette = {
  ...
  custom: {
    darkerBlue: '#001A33', // Custom darker blue
  },
  ...
  yellow: {
    ...
    700: '#FFA000',
    900: '#FF6F00',
    customDark: '#3A2A00', // Custom darker yellow
  },
...
export const lightTheme = {
  ...
  typography: {
    fontFamily: {
      // Using 'System' font family for consistency across platforms
      regular: 'System',
      medium: 'System',
      bold: 'System',
    },
  ...
  // Spacing
  // Function to calculate spacing based on a factor
  // Usage: spacing(factor) where factor is a number
...
export const darkTheme = {
  colors: {
    ...
    // State colors
    success: {
      lightest: palette.green[1000], // Darker green
    ...
    warning: {
      lightest: palette.yellow.customDark, // Darker yellow
    ...
    error: {
      lightest: palette.red[1000], // Darker red
    ...
    info: {
      lightest: palette.custom.darkerBlue, // Darker blue
...
// Exporting the themes as an object to allow easy access to different themes
export default {
  light: lightTheme,
  dark: darkTheme,
