...
const palette = {
  ...
  // Custom
  custom: {
    actionHover: 'rgba(33, 150, 243, 0.08)',
    actionSelected: 'rgba(33, 150, 243, 0.12)',
    lightestWarning: 'rgba(255, 152, 0, 0.12)',
    lightestSuccess: 'rgba(76, 175, 80, 0.12)',
    warningLightest: 'rgba(255, 152, 0, 0.12)',
    successLightest: 'rgba(76, 175, 80, 0.12)',
    errorLightest: 'rgba(244, 67, 54, 0.12)',
  },
  // Lightest shades for transparency
  lightest: {
    blue: 'rgba(33, 150, 243, 0.12)',
  }
};
...
const baseTheme = {
  ...
  // Function to calculate spacing based on a multiplier
  // Usage: spacing(multiplier) where multiplier is a number
...
export const lightTheme = {
  ...
  colors: {
    ...
    background: {
      ...
      selected: palette.custom.selectedBlue,
      disabled: palette.custom.actionDisabled,
      active: palette.blue[500],
      hover: palette.custom.actionHover,
...
export const darkTheme = {
  ...
  colors: {
    ...
    secondary: {
      ...
      contrastText: palette.common.white,
      lightest: palette.custom.errorLightest,
    },
    error: {
    ...
    success: {
      ...
      contrastText: palette.common.white,
      lightest: palette.custom.lightestSuccess,
    },
    text: {
