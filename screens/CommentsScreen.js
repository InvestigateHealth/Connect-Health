...
const CommentsScreen = ({ route, navigation }) => {
  ...
  }, [isConnected, post, postId, navigation]);
  ...
  }, [postId, focusCommentId, fetchPost, fetchComments, scrollToComment]);

  // Memoized function to filter comments
  ...
  }, [blockedUsers, filterComments, comments.length]);
  ...
  }, [postId, lastVisible, blockedUsers]);
  ...
  }, [postId, comments, blockedUsers, editingCommentId]);
  ...
  }, [editingCommentId, editCommentText, isMounted]);
  ...
  }, [hasMoreComments, loadingMore, loading, fetchComments]);
  ...
  }, [loadingMore, theme.colors.primary.main]);

  const renderPostAuthorInfo = useCallback(() => {
    if (!post) return null;
  ...
  }, [post, theme.colors.background.card, theme.colors.text.primary, theme.colors.text.secondary, navigateToUserProfile]);
