...
const UserProfileScreen = ({ route, navigation }) => {
  ...
  const { user, userData: currentUserData, isUserBlocked, blockUser, unblockUser: handleUnblockUser } = useUser();
  ...
  const fetchUserData = async () => {
    ...
    try {
      ...
      if (userDoc.exists && isMounted.current) {
        ...
        Alert.alert('Error', 'User not found. This profile may have been deleted.');
      }
    } catch (error) {
        ...
        >
          <View style={styles.profileImageContainer}>
            {userData?.profileImageURL ? (
              ...
              >
                <Icon name="person" size={40} color={theme.colors.text.inverse} />
              </View>
            )}
          </View>
          ...
          <View style={styles.postsContainer}>
            {userIsBlocked ? (
              <View style={styles.emptyContainer}>
                <Icon name="eye-off-outline" size={50} color={theme.colors.icon.inactive} />
              ...
              <View style={styles.emptyContainer}>
                <Icon name="images-outline" size={50} color={theme.colors.icon.inactive} />
                <Text style={[styles.emptyTitle, { color: theme.colors.text.primary }]}>
                  No Posts Yet
                </Text>
                <Text style={[styles.emptySubtitle, { color: theme.colors.text.secondary }]}>
