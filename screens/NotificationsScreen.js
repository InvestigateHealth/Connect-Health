...
const NotificationsScreen = () => {
  ...
  useEffect(() => {
    if (permissionStatus === 'undetermined') {
      ...
      Alert.alert(
        ...
        'This app needs notification permissions to notify you about important updates.',
    [
  ...
  const notificationItemStyle = (item) => [
  ...
  const renderNotificationItem = ({ item }) => {
    ...
    return (
      <TouchableOpacity 
        style={notificationItemStyle(item)}
  ...
  const renderHeader = () => {
    // Return null if there are no notifications or all notifications are read
      ...
      {loading && !refreshing ? (
        ...
        {permissionStatus === 'denied' && (
          <View style={[styles.permissionBanner, { backgroundColor: theme.colors.warning.light }]}>
            ...
            <TouchableOpacity
              style={[styles.settingsButton, { backgroundColor: theme.colors.primary.main }]}
              onPress={() => Linking.openSettings()}
            >
              <Text style={[styles.settingsButtonText, { color: theme.colors.primary.contrastText }]}>
                Open Settings
              </Text>
            </TouchableOpacity>
          </View>
