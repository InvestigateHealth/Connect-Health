...
import { configureStore, combineReducers, createAsyncThunk, createSlice } from '@reduxjs/toolkit';
...
const persistConfig = {
  ...
  // Whitelist specific reducers to persist: auth, user, theme
  // Whitelist specific reducers to persist: auth, user, theme
  // These reducers are whitelisted because they contain user authentication data, user profile data, and theme preferences, which need to be persisted across sessions.
};
  ...
  middleware: (getDefaultMiddleware) =>
    getDefaultMiddleware({
      serializableCheck: {
        ...
        // Ignore these paths because they contain Date objects which are not serializable: 'payload.timestamp', 'payload.createdAt'
        // Ignore these paths because they contain Date objects which are not serializable
